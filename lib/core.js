...
let printerObject = {
  ...
  drawLine: function(){
    ...
    for(var i=0; i<printerConfig.width; i++) {
      if (printerConfig.lineChar) this.append(new Buffer(printerConfig.lineChar));
  ...
  append: function(buff){
    ...
    if(!buffer && printerConfig.characterSet) buffer = this.setInternationalCharacterSet(printerConfig.characterSet);
